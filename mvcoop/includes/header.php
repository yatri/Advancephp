...
<body>
	<div id="container">
        ...
        <span class="title" style="font-size:18px; text-decoration:none; margin-top:-20px;">All tables inside db_student database:</span><span><a href="index.php?view=student&folder=std" style="margin-left:5em; font-weight:bold;">1) Student Table</a><a href="index.php?view=company&folder=cmpy" style="font-weight:bold; margin-left:5em;">2) Employee Table</a></span><br>
		<br>
